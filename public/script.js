...
const i18n = {
    pt: {
        ...
        promo_desc: "Fundador da Domino Automate, uma boutique de Engenharia Digital e Inteligência Atuarial. Atuamos com governança de riscos, auditoria de balanços (CPC 33), perícia e assistência técnica judicial, além de soluções de hiperautomação e agentes de IA para o mercado corporativo e jurídico.",
        promo_stat1_val: "-90%",
    ...
    en: {
        ...
        promo_desc: "Founder of Domino Automate, a Digital Engineering and Actuarial Intelligence boutique. We work with risk governance, balance sheet auditing (CPC 33), expert testimony and judicial technical assistance, as well as hyperautomation solutions and AI agents for the corporate and legal market.",
        promo_stat1_val: "-90%",
